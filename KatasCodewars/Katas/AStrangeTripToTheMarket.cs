...
namespace KatasCodewars.Katas
{
    public class AStrangeTripToTheMarket
    {
        ...
        {
            if (sentence.Contains("tree fiddy") || sentence.Contains("3.50")
                                                || sentence.Contains("three fifty")
                                                || sentence.Contains("tree Fiddy"))
            {
                return true;
            }
            else
...
//return sentence.ToLower().Contains("tree fiddy") | sentence.Contains("3.50") | sentence.Contains("three fifty");
